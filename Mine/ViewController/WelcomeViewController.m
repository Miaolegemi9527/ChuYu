...
//                    [settingVC presentViewController:settingVC animated:YES completion:^{
//                    }];
...
//{
//    //双击跳过手势
//    UITapGestureRecognizer *goToHomeViewControllerTapGR = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(goToHomeViewController)];
//    goToHomeViewControllerTapGR.numberOfTapsRequired = 2;
//    [self.view addGestureRecognizer:goToHomeViewControllerTapGR];
//}
